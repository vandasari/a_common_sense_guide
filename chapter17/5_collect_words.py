...
class Trie:
    ...
    def collectAllWords(self, node=None, word='', words=[]):
        """
        This method returns an array of all the words in the trie. It accepts 
        three arguments: 
...
if __name__ == '__main__':
    inputStrings = ['ace', 'act', 'cat', 'card', 'hello', 'hug', 'can' ,'dog', 'bald', 
            'ball', 'balance', 'balter']       
    ...
    # Show all words in our dictionary
    print(t.collectAllWords())
